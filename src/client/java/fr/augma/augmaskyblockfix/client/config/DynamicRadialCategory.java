...
public class DynamicRadialCategory {
	...
	private static final String[] SETTING_FIELDS = {"enabled", "keybind", "holdToOpen", "background", "blur", "activateOnRelease", "generalDirection", "sliceColour", "hoverColour", "innerRadius", "outerRadius", "centreDistance", "sliceGap"};
